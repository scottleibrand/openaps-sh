...
grep ^upload-pumphistory-entries /tmp/openaps-aliases || openaps alias add upload-pumphistory-entries '! bash -c "openaps prep-pumphistory-entries && ns-upload-entries monitor/pumphistory.json"' || die "Can't add upload-pumphistory-entries"
