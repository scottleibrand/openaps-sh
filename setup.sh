...
openaps alias add refresh-old-pumphistory-24h '! bash -c "find settings/ -mmin -30 | grep -q pumphistory-24h-zoned || openaps report invoke settings/pumphistory-24h.json settings/pumphistory-24h-zoned.json"'
