...
grep monitor/pumphistory.json /tmp/openaps-reports || openaps report add monitor/pumphistory.json JSON pump iter_ump_hours 6 || die "Can't add pumphistory.json"
